...
def letterbox(im, img_idx, new_shape=(640, 640), color=(114, 114, 114), auto=True, scaleFill=False, scaleup=True, stride=32):
...
def letterbox2(img, idx, new_shape=(640, 640), color=(114, 114, 114), auto=False, scaleFill=False, scaleup=True, stride=32):
    # Resize and pad image while meeting stride-multiple constraints
    ...
    cv2.imwrite("/home/toanhoang/Pictures/{:05d}.jpg".format(idx), img)
